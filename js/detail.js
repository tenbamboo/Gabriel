    ...
    showDetail: function () {
        ...
        switch (val) {
            ...
            case '3':
                ...
                break;
            case '4':
                res = `<p>内驱4：现实、 诚信、稳重 、忠诚。靠谱的男人和居家过日子的女人</p><p class="red">修行功课：不要为了安全感不足而做事</p>`
                break;
            case '5':
            ...
            case '6':
                ...
                break;
            case '7':
                res = `<p>内驱7：学习、思考、涵养、被懂大于一切</p><p class="red">修行功课：在关系中，有时候需要主动</p>`
                break;
            case '8':
                res = `<p>内驱8：权威、事业心、领袖、心想事成。有远大抱负的人</p><p class="red">修行功课：接纳失败是生命的一部分</p>`
                break;
            case '9':
