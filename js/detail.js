...
var Index = {
    ...
    showDetail: function () {
        ...
        switch (val) {
            case '1':
                res = `<p>内驱1：独立、自信、不依赖、有力量。最man的男人和最有主见的女人</p><p class="red">修行功课：允许自己做不到，不要为了证明自己可以而勉强自己</p>`
                break;
            case '2':
                res = `<p>内驱2：体贴、包容、合作、舒服。暖男和温柔似水的女性</p><p class="red">修行功课：不要为了关系和谐而委屈自己。</p>`
                break;
            case '3':
                res = `<p>内驱3：简单 、直接 、幽默、好玩 、颜值、 面子</p><p class="red">修行功课：不要为了面子而做事</p>`
                break;
            case '4':
                res = `<p>内驱4：现实、 诚信、稳重 、忠诚。靠谱的男人和居家过日子的女人</p><p class="red">修行功课：不要为了安全感不足而做事，学会享受并活在当下</p>`
                break;
            case '5':
                res = `<p>内驱5：精力旺盛、魅力、爱自由、多变</p><p class="red">修行功课：不要为了尝试刺激而冒险</p>`
                break;
            case '6':
                res = `<p>内驱6：善良、顾家、责任心、付出</p><p class="red">修行功课：不要一味地付出，爱别人而忘记了自己</p>`
                break;
            case '7':
                res = `<p>内驱7：学习、思考、涵养、被懂大于一切</p><p class="red">修行功课：有些话不说出来别人是真的不知道，尝试表达出内心的想法</p>`
                break;
            case '8':
                res = `<p>内驱8：权威、事业心、领袖、心想事成。有远大抱负的人</p><p class="red">修行功课：接纳失败是生命的一部分，越挫越勇</p>`
                break;
            case '9':
                res = `<p>内驱9：大爱、无我、被需要。最富有同情心的人</p><p class="red">修行功课：爱别人之前要爱自己，分清界限</p>`
                break;
        }
